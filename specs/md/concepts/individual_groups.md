...
1.  Generate a top-level group entity for each of the campus divisions and locations listed below.
    ...
    **Yale University Library \(campus division\)**
    ...
    **Bass Library \(member of Yale University Library\)**
    ...
    **Yale University Art Gallery Numismatics**
...
2.  Generate a top-level group entity for the additional groups listed below.
...
3.  Include an embedded reference to the group entity in the appropriate context.

    1.  YUL, YCBA, and YUAG collections as defined in [Library locations and collections](library_collections.md).
