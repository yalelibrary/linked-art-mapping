...
1.  Process the medium of performance values \(MARC`382ans`\).
    ...
    |**382ans**|For `382s` following one or more `382an` pairs, join the following values to the `382an` value(s) with a whitespace character: 1.  “Total number of performers:” <br/> 2.  `382s` + “.”|
