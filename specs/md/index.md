...
-   [Entity modeling](concepts/entity_extraction.md)
    -   [LUX top-level entities](concepts/lux_top-level_entities.md)
        ...
        -   [Related entities](tasks/related_entities.md)
            ...
            -   [Complex subject/genre headings - v1.2](tasks/concepts/complex_subject_headings.md)
            -   [Place hierarchies - v1.2](tasks/concepts/hierarchical_places.md)
            ...
            -   [Concepts](concepts/concepts.md)
                ...
                -   [Roles - v1.2](tasks/concepts/roles.md)
            ...
            -   [Sets](concepts/related_sets.md)
                -   [Repository collections - v1.2](concepts/library_collections.md)
-   [Descriptive content](concepts/descriptive_content.md)
    -   [Embedded entities](concepts/lux_embedded_entities.md)
        -   [Digital object link to catalog - v1.2](concepts/digital_objects.md)
        -   [Digital object link to asset - v1.2](concepts/digital_objects_asset_link.md)
        -   [Publication activities - v1.3](concepts/publication_activities.md)
        -   [Copyright entities - v1.3](concepts/copyright_entity.md)
    ...
    -   [Names and labels](concepts/names_and_labels.md)
        -   [Names](tasks/names-and-labels/names.md)
            ...
            -   [Sorting name - v1.2](tasks/names-and-labels/sorting_name.md)
    ...
    -   [Notes and statements](concepts/notes_and_statements.md)
        ...
        -   [Table of contents - v1.2](tasks/notes-and-statements/table_of_contents.md)
